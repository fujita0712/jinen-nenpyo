...
- 良い出来事だけでなく、挫折や痛みも同じ熱量で具体的に描くこと。受験の失敗、就職活動でのつまずき、大きな恋愛関係とその終わり(失恋)のような、山も谷も両方はっきり書いてよい。予定調和な美談にまとめず、うまくいかなかったこと・傷ついたことも、成功体験と同じ解像度で描写すること。入力データ(過去5年以内のライフイベント等)に該当する出来事があれば、それを軸に具体的に踏み込むこと。

【読者の心理に寄り添う書き方(最重要)】
占い鑑定を読む人は、自己理解と承認を求め、過去に一貫した意味を見出すことで安心感を得ようとしている。この心理を踏まえ、以下を満たすこと:
- 承認: 各Chapterに、これまでの選択・感じ方・行動を否定せず「それでよかった」「そう感じるのは自然なことだ」と肯定する一文を最低1つ入れること。読者が「自分は間違っていなかった」と思えるように書く。
- 普遍的な感情 × 具体的なアンカー: 孤独感・比較される辛さ・期待と本音のズレ・「自分だけこう感じているのでは」という不安のような、多くの人が経験する普遍的な感情を土台にしつつ、年齢・出生順位・占術データという具体的なアンカーと組み合わせることで「これは自分だけに向けた話だ」と感じられるようにすること。
- 過去の出来事は、偶然の羅列ではなく、今の自分につながる一貫した物語として描くこと。不確実だった過去に筋の通った意味を与えることで、読者に「今の自分は必然の結果だ」という安心感とコントロール感を持たせる。
...
2. 各Chapterの本文(body)は320〜420文字程度の分量を持たせ、読みごたえのある内容にすること。次の5項目のうち最低3つを必ず含めること: 年齢(具体的な年齢や年代)/出生順位(長子・中間・末子など)/兄弟構成(人数)/感情の描写/具体的な行動カテゴリ
