...
2. 各年について「仕事」「恋愛」「金運」「家族」の4テーマそれぞれに1〜2文の短い文章を書くこと(1テーマあたり40〜90文字程度)。ただしperiodTypeが"steady"の年は、4テーマとも短く軽い扱いで構わない(この人の人生の主役はあくまで節目の年である)。
...
6. 各年に advice(一言アドバイス)を1つ添えること。periodTypeが"decisive"「"turning_point"「"endurance"の年は、その年の4テーマの内容と具体的に紐づいた、この年ならではの行動や心構えを20〜40文字程度で書くこと。「一人で抱え込まず、早めに相談を」のような汎用フレーズの使い回しは避け、その年の具体的な状況(何についての決断か、何が変わるのか)が分かるアドバイスにすること。"steady"の年は「今のペースを維持で十分」のような軽い一言で構わない。
